...
public class WorldGen : MonoBehaviour
{
    ...
    private void GenerateTerrain(Vector2 chunkPos, ref Dictionary<short[], short> cubes)
    {
    ...
    private void ApplyModifiedBlocks(Vector2 chunkPos, ref Dictionary<short[], short> cubes)
    {
